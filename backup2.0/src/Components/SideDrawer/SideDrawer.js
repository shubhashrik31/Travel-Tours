    ...
    <div className={classes}>
      ...
      <ul className="SideMenu">
        ...
        <div className={subMenuState ? "SubMenu displaySubMenu" : "SubMenu"}>
          ...
          <NavLink to="/ThemesToExplore/Mountains" onClick={props.clicked}>
            Mountains
          </NavLink>
          <NavLink to="/ThemesToExplore/Heritage" onClick={props.clicked}>
            Heritage
          </NavLink>
          <NavLink to="/ThemesToExplore/Pilgrimage" onClick={props.clicked}>
            Pilgrimage
          </NavLink>
        </div>
        <li>
